...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private Button LogoutBtn,CreateBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(conMgr.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED || conMgr.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED){
            try{
                ...
                mRef = database.getReference("/Version");
        ...
        CreateBtn.setOnClickListener(CreateLis);
    ...
    private boolean isEmailValid(String email) {
        ...
        return email.contains("@")&&email.contains("nttu.edu.tw");
    }
    ...
    public Button.OnClickListener Logout = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            FirebaseAuth.getInstance().signOut();
            Toast.makeText(LoginActivity.this,"Successfully Logout",Toast.LENGTH_SHORT).show();
        }
    };

    public Button.OnClickListener CreateLis = new Button.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent i = new Intent();
    ...
    private void getnewversion(){
        mRef = database.getReference("/new_url");
        mRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
